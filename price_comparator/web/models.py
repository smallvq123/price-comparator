...
class Goods(models.Model):
    ...
    g_url = models.CharField(max_length=2048, unique=True) #
    g_from = models.IntegerField() # 商品类型 1，taobao   TODO enum
    g_name = models.CharField(max_length=256) # 商品名称
    price_lasted = models.DecimalField() # 商品最新价格
    price_moniter = models.DecimalField() # 监控价格 当最新价格不一致时 needs_update变成true
